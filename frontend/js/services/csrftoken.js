myApp.service('CsrfTokenService', function ($timeout,$cookies) {
    csrfservice = {};
    this.getCookie = function(c_name)
    {
        //console.log(c_name,"c_name");
        //console.log(document.cookie.get(c_name));
        this.token="";
       ...
       return $timeout(function () {
            ...
            {
                document.cookie.put("csrftoken",sha256_digest($.jStorage.get("id")));
            }
